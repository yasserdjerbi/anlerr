odoo.define('pos_ui_design', function (require) {
    ...
    screens.ProductScreenWidget.include({
        ...
        handle_draggable: function (event, ui) {
            ...
            this.pos.set('crop_mode', {
                state: 'disconnected',
                pending: '( ' + this._get_count_message_need_save() + ' ) waiting Save'
            });
        },
        ...
        _event_widget: function () {
            ...
            this.$('.confirm').click(function () {
                ...
                self.pos.set('crop_mode', {
                    state: 'disconnected',
                    pending: '( ' + self.product_screen._get_count_message_need_save() + ' ) waiting Save'
                });
                self.pos.gui.show_popup('confirm', {
                    title: _t('Succeed'),
